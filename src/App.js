...
const basket_of_organic_foods = 'https://raw.githubusercontent.com/rahmanhafizur/Chaldal/refs/heads/main/src/assets/Pusti%20Soyabean%20Oil%205Litter.webp'; // Using the provided contentFetchId URL
...
function App() {
  ...
  return (
    <>
    {/* Removed this header as the login/signout buttons will be inside the nav */}
    {/* <header className="w-full flex justify-end p-4 z-50 bg-transparent">
        {userBool ? (
          <div className="flex items-center space-x-2">
            <div className="avatar w-8 h-8 rounded-full bg-blue-500 text-white flex items-center justify-center font-bold">
              {user[0]}
            </div>
            <button
              onClick={() => {
      ...
      <nav className="fixed top-0 w-full bg-white shadow-md z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-6 lg:space-x-12">
            ...
            {/* Auth Buttons - Now inside the navbar */}
            {userBool ? (
              <div className="flex items-center space-x-2">
                <div className="avatar w-8 h-8 rounded-full bg-blue-500 text-white flex items-center justify-center font-bold">
                  {user[0]}
              ...
              <div className="hidden md:flex items-center space-x-2"> {/* Added hidden md:flex for responsiveness */}
                <button onClick={handleSignInClick} className="px-4 py-2 sm:px-6 sm:py-2 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition select-none">
                  Sign In
                </button>
